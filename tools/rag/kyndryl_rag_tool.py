...
class KyndrylRAGSearch:
    ...
    def search(
        ...
        """
        Search Kyndryl documents for relevant chunks.
...
def search_kyndryl_documents(
    ...
    - Kyndryl benefits, policies, or procedures
    - Healthcare coverage, surgeries, hospitals
    - Employee benefits and insurance
    - Any Kyndryl-specific documentation
